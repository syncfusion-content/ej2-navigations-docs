...
{% include code-snippet/tab/adaptive-popup-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/tab/adaptive-popup-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
...
{% include code-snippet/tab/adaptive-popup-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/tab/adaptive-popup-cs1/index.html %}
{% endhighlight %}
