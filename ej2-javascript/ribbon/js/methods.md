...
The [removeItem](https://ej2.syncfusion.com/javascript/documentation/api/ribbon/#removeitem) method is used to remove an item from the ribbon component. This method takes the `itemId` as a parameter.
