...
You can customize the dropdown button item by specifying a custom class through the [beforeItemRender](https://ej2.syncfusion.com/documentation/ribbon/events#beforeitemrender) event.
